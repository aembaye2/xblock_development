...
VERSION = get_version('drawing', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/xblock-drawing',
    install_requires=load_requirements('requirements/base.in'),
    entry_points={
        'xblock.v1': 'drawing = drawing:DrawingBlock',
    },
    packages=['drawing'],
    package_data=package_data("drawing", ["static", "templates", "public", "translations"]),
