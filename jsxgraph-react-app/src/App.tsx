...
function App() {
  ...
  const [minX, setMinX] = useState<number>(-.5);
  const [maxX, setMaxX] = useState<number>(10.5);
  const [minY, setMinY] = useState<number>(-1);
  const [maxY, setMaxY] = useState<number>(10.5);

  // Default board configuration
  const boardSize: [number, number, number, number] = [minX, maxY, maxX, minY]; // [left, top, right, bottom]
  const boardPixelSize: [number, number] = [500, 450]; // [width, height]
            ...
            <div className="flex gap-6 items-end justify-center">
              <div>
                ...
                <input
                  ...
                  className="w-[10rem] px-2 py-1 border border-zinc-100 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-700 text-zinc-900 dark:text-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
                  placeholder="x"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-[10rem] px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-700 text-zinc-900 dark:text-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
                  placeholder="y"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 items-end justify-center flex-wrap">
              <div>
                ...
                <input
                  ...
                  className="w-[4rem] px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md bg-white dark:bg-zinc-700 text-zinc-900 dark:text-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
                />
              </div>
              <div>
