(function () {
	...
	*/
	...
	var toKeyedReactNode = function (reactNode, key) {
	    return reactExports.isValidElement(reactNode)
	        ? reactExports.cloneElement(reactNode, { key: key })
	        : reactNode;
	};
	/**
	 ...
	 */
	return (_a = reactExports.Children.map(children, toKeyedReactNode)) !== null && _a !== void 0 ? _a : []; };
	/**
	...
	const StudioView = ({ runtime, questionText, max_attempts, weight, has_score, index, AssessName, visibleTools, visibleButtons, boardSize, boardPixelSize, expectedDrawing, initialDrawingState, gradingTolerance, gradingConfig }) => {
	    ...
	    const [boardPixelSizeStr, setBoardPixelSizeStr] = React.useState(Array.isArray(boardPixelSize) ? boardPixelSize.join(', ') : '600, 500');
...
//# sourceMappingURL=diagram_studio.js.map
