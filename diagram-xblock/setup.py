...
VERSION = get_version('diagram', '__init__.py')
...
setup(
    ...
    entry_points={
        'xblock.v1': [
            'diagram_xblock = diagram:DiagramXBlock',
        ]
    },
    package_data=package_data("diagram", ["static", "public"]),
