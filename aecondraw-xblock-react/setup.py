...
VERSION = get_version('aecondraw', '__init__.py')
...
setup(
    ...
    entry_points={
        'xblock.v1': [
            'aecondraw_xblock = aecondraw:AecondrawXBlock',
        ]
    },
    package_data=package_data("aecondraw", ["static", "public"]),
