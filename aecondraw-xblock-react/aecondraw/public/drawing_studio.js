	...
	*/
	...
	var toArbitrarilyKeyedReactNode = function (reactNode) {
	    return reactExports.isValidElement(reactNode)
	        ? reactExports.createElement(reactExports.Fragment, arbitraryKeyProps, reactNode)
	        : reactNode;
	};
	/**
	 ...
	 */
	return (_a = reactExports.Children.map(children, toArbitrarilyKeyedReactNode)) !== null && _a !== void 0 ? _a : []; };
	/**
	...
	const StudioView = ({ runtime, question, max_attempts, weight, has_score, index, AssessName, canvasWidth, canvasHeight, scaleFactors, bgnumber, visibleModes, axisLabels, hideLabels, initialDrawing }) => {
	    ...
	    return (jsxRuntimeExports.jsxs("div", { className: "myxblock-studio", style: { padding: '20px', maxWidth: '800px' }, children: [jsxRuntimeExports.jsxs("div", { style: {
	                    ...
	                    paddingBottom: '6px',
	                    zIndex: 2
	                }, children: [jsxRuntimeExports.jsx("h2", { style: { margin: 0, fontSize: '24px', fontWeight: 'bold' }, children: "Edit Drawing XBlock" }), jsxRuntimeExports.jsxs("div", { style: { display: 'flex', gap: '10px' }, children: [jsxRuntimeExports.jsx("button", { onClick: save, disabled: isSaving, style: {
	                                    padding: '8px 16px',
