...
class AecondrawXBlock(ScorableXBlockMixin, XBlock):
    ...
    def send_drawing_json(self, data, suffix=''):
        ...
        from .aecondraw_handlers import process_drawing_json
...
# }
    ...
    def student_view(self, context=None):
        ...
        frag.initialize_js('initAecondrawXBlockStudentView', init_data)
        return frag
    ...
    def studio_view(self, context=None):
        ...
        frag.initialize_js('initAecondrawXBlockStudioView', init_data)
        return frag
    ...
    def workbench_scenarios(cls):
        ...
        return [
            ("AecondrawXBlock based on react", "<aecondraw_xblock/>")
        ]
