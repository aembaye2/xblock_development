#!/usr/bin/env python
"""
Package metadata for react_xblock_2.
"""
import os
import re
import sys
...
VERSION = get_version('react_xblock_2', '__init__.py')
...
setup(
    ...
    url='https://github.com/open-craft/xblock-react-5',
    packages=find_packages(
        include=['react_xblock_2', 'react_xblock_2.*'],
        exclude=["*tests"],
    ),
