...
git commit -m "Bump to V1.0.10"  && git tag -a V1.0.10 -m "Release V1.0.10"  && git push origin main --follow-tags
...
tutor config save --append OPENEDX_EXTRA_PIP_REQUIREMENTS="git+https://github.com/aembaye2/xblock_development.git@V1.0.10#subdirectory=diagram-xblock"