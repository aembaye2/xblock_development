...
def process_drawing_json(drawing: Any, scaleFactors: list = None, canvasWidth: float = None, canvasHeight: float = None) -> str:
    """Return a summary of the drawing by listing each object with details for lines.
    ...
    objects = []
    if isinstance(drawing, dict) and 'objects' in drawing and isinstance(drawing['objects'], list):
