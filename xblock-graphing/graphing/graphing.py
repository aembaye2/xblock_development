...
@XBlock.needs('i18n')
class GraphingXBlock(ScorableXBlockMixin ,XBlock):
    """
    ...
    item_background_color = String(
        ...
        help=_("The background color of graphing items"),
        scope=Scope.settings,
        default="#f2f2f2",
        enforce_type=True,
    )
    ...
    item_text_color = String(
        ...
        help=_("The text color of graphing items"),
        scope=Scope.settings,
        default="#000000",
        enforce_type=True,
    )
    ...
    def student_view(self, context=None):
        """
        The primary view of the graphingXBlock, shown to students
        ...
        frag.initialize_js('GraphingXBlock')
        return frag
    ...
    def submit_answer(self, submission, suffix=''):
        ...
        message = GraphingXBlock.FEEDBACK_MESSAGES[int(self.raw_earned)].format(earned, total)
    ...
    def studio_view(self, context):
        ...
        frag.initialize_js('GraphingXBlockEdit')
        return frag
